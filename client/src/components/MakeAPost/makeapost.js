  ...
  const {
    ...
    onSubmit: (values) => {
      try {
        ...
        axios
          .post("http://localhost:3001/api/post/save/", {
          ...
          .then((res) => {
            console.log(res);
            MySwal.fire({ title: <h2> Posteado </h2> }).then(() => {
              Navigate("/home");
            });
          })
        ...
        <div className="my-child-container-form ">
          ...
          <label className="d-flex">
            <input
              ...
              className="my-input-form my-title-input "
            />
          </label>
          ...
          <textarea
            ...
            rows="12"
            className="my-input-form my-text-area"
          ...
          <label className="d-flex">
            <input
              type="text"
              {...getFieldProps("urlPhoto")}
              placeholder="Ingresa una url de imágen aquí..."
              className="my-input-form my-input-url"
            />
          </label>
        </div>
      </form>
